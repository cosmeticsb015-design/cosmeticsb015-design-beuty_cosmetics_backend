...
export interface ApiBranchStockBranchStock extends Struct.CollectionTypeSchema {
  collectionName: 'branch_stocks';
  info: {
    displayName: 'Branch Stock';
    pluralName: 'branch-stocks';
...
export interface ApiOrderItemOrderItem extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    variant: Schema.Attribute.Relation<
      ...
      'api::variant-option.variant-option'
    >;
    variant_label: Schema.Attribute.String;
  };
}
...
export interface ApiOrderOrder extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    shipping_rate: Schema.Attribute.Relation<
      'manyToOne',
...
export interface ApiVariantOptionVariantOption
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    price_override: Schema.Attribute.String;
    product: Schema.Attribute.Relation<'manyToOne', 'api::product.product'>;
    publishedAt: Schema.Attribute.DateTime;
    stocks: Schema.Attribute.Relation<
      'oneToMany',
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::branch-stock.branch-stock': ApiBranchStockBranchStock;
